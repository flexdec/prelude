 ...
 ;;Add touch to dired, thanks to http://www.emacswiki.org/emacs/dired-extension.el
 (define-key dired-mode-map (kbd "c") 'dired-touch-now)
 ...
 ;;smartparens is too intrusive
 (defun disable-smartparens ()
   (smartparens-mode 0)
   )

 (add-hook 'prelude-mode-hook 'disable-smartparens)
